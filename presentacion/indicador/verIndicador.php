...
<div class="columns is-mobile">
  <div class="column is-2 is-offset-10"> 
    <div class="control">
		<a class="button is-light" style="border: 1px solid"  href="index.php?pid=<?php echo base64_encode("presentacion/categoria/verCategoria.php") . "&idCategoria=". $indicador -> getCategoria_idCategoria()?>" >Atras</a>
	</div>
  </div>
</div>